    ...
    protected static function boot()
    {
        ...
        static::created(function ($newStandaloneDocker) {
            ...
            instant_remote_process([
                dockerNetworkInspectCommand($newStandaloneDocker->network).' >/dev/null 2>&1 || '.dockerNetworkCreateCommand($newStandaloneDocker->network, attachable: true, driver: 'overlay').' >/dev/null',
            ], $server, false);
